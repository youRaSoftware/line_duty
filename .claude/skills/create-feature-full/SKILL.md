...
Read **`.claude/shared/line_duty_ui_reference.md`** in full — § 4.2–4.5 describe the exact model / repository / provider / DI / cubit shapes used here. Screen spec: `.claude/my_docs/SPEC.md`.
...
Follow Line Duty full feature patterns.
```

## How Line Duty stores data
