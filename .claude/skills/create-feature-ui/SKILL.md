...
Read **`.claude/shared/line_duty_ui_reference.md`** in full (tokens, widget inventory, composition rules, code style). For the screen's visual spec read the matching frame in `.claude/my_docs/SPEC.md` § 2.
...
Follow Line Duty UI feature patterns.
```
